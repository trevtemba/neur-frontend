...
const UpdateService = ({ isOpen, onClose, btnAnims, tempService, setTempService, clearTempService, patchServiceInfo }) => {
    ...
    return (
            ...
            >
                <motion.div className="updateServiceModal" 
                onClick={(e) => e.stopPropagation()}
                key="updateServiceModal"
                initial={{
                    y: 50,
                }}
                animate={{
                ...
                >
                    <form className="addServiceForm" onSubmit={(e) => patchServiceInfo(e)}>
